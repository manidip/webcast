                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                foreach($categories as $category)
                                {
                                    ...
                                    <td><a class="btn btn-sm btn-block btn-info" href="<?php echo base_url()."admin/category/add?id=".$validH->xssSafe($category->id); ?>">Edit</a>
                                        <a class="btn btn-sm btn-block btn-danger" href="<?php echo base_url().'admin/category/delete?id='.$validH->xssSafe($category->id) ?>&<?php echo $csrfToken['name']; ?>=<?php echo md5($csrfToken['hash'].$this->session->csrf_salt); ?>" class="delBtn" title="Delete">Delete</a>
                                    </td>
                                    </tr>
                                    <?php
                                    $c++;
