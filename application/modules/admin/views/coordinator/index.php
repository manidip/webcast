...
<div class="row">
    ...
    <div class="col-md-6">
     ...
     <div class="row pull-right" style="padding-top:20px;">
        ...
        <div class="col-md-6">  
        <div class="form-group">   
        <label class="control-label">Items/Page</label>     
     ...
     <table class="table table-bordered table-hover">
            ...
            <?php  
				...
				?>
                    ...
                    <td align="left" valign="top">
                    <?php
					echo $validH->xssSafe($coordinator->organization);
					?>
                    </td>
                  ...
                  <td valign="top">
                  <a href="<?php echo base_url()."admin/coordinator/add?id=".$validH->xssSafe($coordinator->id); ?>">Edit</a> | 
                  <a href="<?php echo base_url().'admin/coordinator/delete?id='.$validH->xssSafe($coordinator->id) ?>&<?php echo $csrfToken['name']; ?>=<?php echo md5($csrfToken['hash'].$this->session->csrf_salt); ?>" class="delBtn" title="Delete">Delete</a>
