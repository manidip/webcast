...
<input type="text" class="form-control" placeholder="" name="email" id="email" value="<?php if($data_posted){ echo set_value('email'); } else{ if(!empty($usrRec)){ echo $validH->xssSafe($usrRec->email); }} ?>"></div>
</div>
</div>
