     ...
     <table class="table table-bordered table-hover">
            ...
            <?php  
				...
				?>
                  ...
                  <td valign="top">
                  <a href="<?php echo base_url()."admin/admin_user/add?id=".$validH->xssSafe($admin_user->id); ?>">Edit</a> | 
                  <a href="<?php echo base_url().'admin/admin_user/delete?id='.$validH->xssSafe($admin_user->id) ?>&<?php echo $csrfToken['name']; ?>=<?php echo md5($csrfToken['hash'].$this->session->csrf_salt); ?>" class="delBtn" title="Delete">Delete</a>
